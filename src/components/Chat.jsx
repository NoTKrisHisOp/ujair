...
import { collection, addDoc, onSnapshot, query, orderBy, where, serverTimestamp, getDocs } from 'firebase/firestore';
    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="bg-gray-100 p-4 border-b">
        <div className="flex items-center justify-between">
          ...
          <div className="w-64">
            <label htmlFor="recipient" className="block text-gray-700 text-xs font-medium mb-1">Chat with</label>
            <select
              id="recipient"
              value={recipient}
